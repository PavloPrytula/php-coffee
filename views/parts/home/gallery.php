        ...
        <div class="row row-cols-2">
            <div class="col-12 col-md-4">
                <div class="row">
                    ...
                    <div class="col-12">
                        <img src="assets/img/g2.jpg" class="img-fluid w-100 mb-3">
                    </div>
                </div>
            </div>
            <div class="col-8 col-md-8">
                <div class="col-12">
                    <img src="assets/img/g3.jpg" class="img-fluid w-100 mb-3">
                </div>
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <img src="assets/img/g5.jpg" class="img-fluid w-100 mb-3">
                        </div>
                    </div>
                </div>
            </div>
